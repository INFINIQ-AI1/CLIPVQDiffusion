...
#         if phase=="train":
#             self.cropper = albumentations.Compose([albumentations.RandomCrop(height=size, width=size)],
#                                                     additional_targets=additional_targets)
#         else:
#             self.cropper = albumentations.Compose([albumentations.CenterCrop(height=size, width=size)],
#                                                     additional_targets=additional_targets)            
